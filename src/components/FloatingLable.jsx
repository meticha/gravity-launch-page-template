...
const FloatingLabel = () => {
  ...
  const productHuntText = " VISIT NOW ";
  ...
  const FloatingButton = ({
    ...
    >
      <div
        className={`relative w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 lg:w-[100px] lg:h-[100px] ${bgColor} rounded-full overflow-hidden transition-colors duration-300 group-hover:bg-black`}
      >
        {/* Rotating Text */}
        <motion.div
  ...
  return (
    <>
      ...
      />
      <FloatingButton
        href="https://jetpackcomposesnippets.meticha.com"
        text={productHuntText}
        characters={charactersProductHunt}
        bgColor={"bg-purple-600"}
        src="https://jetpackcomposesnippets.meticha.com/_vercel/image?url=%2Fassets%2Fimages%2FMdiApplicationBracesOutline_1.png&w=1536&q=100"
